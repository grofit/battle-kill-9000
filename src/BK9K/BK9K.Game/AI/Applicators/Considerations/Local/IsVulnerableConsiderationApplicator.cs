...
{
    public class IsVulnerableConsiderationApplicator : DefaultLocalConsiderationApplicator<Unit>
    {
        ...
        {
            return new UtilityBasedConsideration(new UtilityKey(UtilityVariableTypes.IsVulnerable), new UtilityKey(UtilityVariableTypes.IsDefensive), PresetCurves.InverseLinear);
        }
    }
}